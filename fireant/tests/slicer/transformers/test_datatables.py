        ...
        self.assertDictEqual({
            'data': [{'cont': {'value': 0}, 'cat1': {'display': '_total', 'value': '_total'},
                     ...
                     {'cont': {'value': 0}, 'cat1': {'display': 'A', 'value': 'a'}, 'one': {'display': '2', 'value': 2},
                      'two': {'display': '102', 'value': 102}, 'uni': {'display': 'Cc', 'value': 3}},
                     ...
                     {'cont': {'value': 0}, 'cat1': {'display': 'B', 'value': 'b'}, 'one': {'display': '5', 'value': 5},
                      'two': {'display': '105', 'value': 105}, 'uni': {'display': 'Cc', 'value': 3}},
                     ...
                     {'cont': {'value': 1}, 'cat1': {'display': 'A', 'value': 'a'}, 'one': {'display': '8', 'value': 8},
                      'two': {'display': '108', 'value': 108}, 'uni': {'display': 'Cc', 'value': 3}},
        ...
        self.assertDictEqual({
            ...
            'data': [
                {'one': {'value': 12, 'display': '12'}, 'two': {'value': 24, 'display': '24'}, 'cont': {'value': 0},
                 'cat1': {'value': Totals.key, 'display': Totals.label}, 'cat2': {'value': Totals.key, 'display': Totals.label}},
    ...
    def test_rollup_cont_cat_uni_dims_multi_metric_df(self):
        ...
        self.assertDictEqual({'data': [
            ...
            'columns': [{'title': 'Cont', 'data': 'cont', 'render': {'_': 'value', 'type': 'value', 'sort': 'value'}},
                        {'title': 'One', 'data': '_total._total.one', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'One (A, Aa)', 'data': 'a.1.one', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'One (A, Bb)', 'data': 'a.2.one', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'One (A, Cc)', 'data': 'a.3.one', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'One (A)', 'data': 'a._total.one', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'One (B, Aa)', 'data': 'b.1.one', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'One (B, Bb)', 'data': 'b.2.one', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'One (B, Cc)', 'data': 'b.3.one', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'One (B)', 'data': 'b._total.one', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'Two', 'data': '_total._total.two', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'Two (A, Aa)', 'data': 'a.1.two', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'Two (A, Bb)', 'data': 'a.2.two', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'Two (A, Cc)', 'data': 'a.3.two', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'Two (A)', 'data': 'a._total.two', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'Two (B, Aa)', 'data': 'b.1.two', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'Two (B, Bb)', 'data': 'b.2.two', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'Two (B, Cc)', 'data': 'b.3.two', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}},
                        {'title': 'Two (B)', 'data': 'b._total.two', 'render': {'_': 'display', 'type': 'value', 'sort': 'value'}}]},
            result)
    ...
    def test_rollup_cont_cat_cat_dims_multi_metric_df(self):
        ...
        self.assertDictEqual({
            ...
            'data': [{'b': {'z': {'two': {'value': 6, 'display': '6'}, 'one': {'value': 3, 'display': '3'}},
                      ...
                      'cont': {'value': 0},
                      Totals.key: {Totals.key: {'two': {'value': 24, 'display': '24'}, 'one': {'value': 12, 'display': '12'}}}},
                     {'b': {'z': {'two': {'value': 14, 'display': '14'}, 'one': {'value': 7, 'display': '7'}},
                      ...
                      'cont': {'value': 1},
                      Totals.key: {Totals.key: {'two': {'value': 88, 'display': '88'}, 'one': {'value': 44, 'display': '44'}}}},
                     {'b': {'z': {'two': {'value': 22, 'display': '22'}, 'one': {'value': 11, 'display': '11'}},
                      ...
                      'cont': {'value': 2},
                      Totals.key: {Totals.key: {'two': {'value': 152, 'display': '152'}, 'one': {'value': 76, 'display': '76'}}}},
                     {'b': {'z': {'two': {'value': 30, 'display': '30'}, 'one': {'value': 15, 'display': '15'}},
                      ...
                      'cont': {'value': 3},
                      Totals.key: {Totals.key: {'two': {'value': 216, 'display': '216'}, 'one': {'value': 108, 'display': '108'}}}},
                     {'b': {'z': {'two': {'value': 38, 'display': '38'}, 'one': {'value': 19, 'display': '19'}},
                      ...
                      'cont': {'value': 4},
                      Totals.key: {Totals.key: {'two': {'value': 280, 'display': '280'}, 'one': {'value': 140, 'display': '140'}}}},
                     {'b': {'z': {'two': {'value': 46, 'display': '46'}, 'one': {'value': 23, 'display': '23'}},
                      ...
                      'cont': {'value': 5},
                      Totals.key: {Totals.key: {'two': {'value': 344, 'display': '344'}, 'one': {'value': 172, 'display': '172'}}}},
                     {'b': {'z': {'two': {'value': 54, 'display': '54'}, 'one': {'value': 27, 'display': '27'}},
                            Totals.key: {'two': {'value': 106, 'display': '106'}, 'one': {'value': 53, 'display': '53'}},
                      ...
                      'cont': {'value': 6},
                      Totals.key: {Totals.key: {'two': {'value': 408, 'display': '408'}, 'one': {'value': 204, 'display': '204'}}}},
                     {'b': {'z': {'two': {'value': 62, 'display': '62'}, 'one': {'value': 31, 'display': '31'}},
                            Totals.key: {'two': {'value': 122, 'display': '122'}, 'one': {'value': 61, 'display': '61'}},
                            'y': {'two': {'value': 60, 'display': '60'}, 'one': {'value': 30, 'display': '30'}}},
                      'a': {'z': {'two': {'value': 58, 'display': '58'}, 'one': {'value': 29, 'display': '29'}},
                            Totals.key: {'two': {'value': 114, 'display': '114'}, 'one': {'value': 57, 'display': '57'}},
                            'y': {'two': {'value': 56, 'display': '56'}, 'one': {'value': 28, 'display': '28'}}},
                      'cont': {'value': 7},
                      Totals.key: {Totals.key: {'two': {'value': 472, 'display': '472'}, 'one': {'value': 236, 'display': '236'}}}}
                ]},
            result)
