...
class HighchartsLineChartTransformerTests(TestCase):
    ...
    def test_single_metric_line_chart(self):
        ...
        self.assertEqual({
            ...
            "plotOptions": {
                "series": {
                    "pointInterval": 126230400000.0,
                    "pointStart": 820454400000.0
                }
            },
            ...
            "series": [{
                ...
                "name": "Votes",
                "yAxis": "0",
                "data": [15220449.0, 16662017.0, 19614932.0, 21294215.0, 20572210.0, 18310513.0],
                "color": "#DDDF0D",
    ...
    def test_single_metric_with_uni_dim_line_chart(self):
        ...
        self.assertEqual({
            ...
            "series": [{
                ...
                "name": "Votes (Texas)",
                "yAxis": "0",
                "data": [5574387.0, 6233385.0, 7359621.0, 8007961.0, 7877967.0, 5072915.0],
                "color": "#DDDF0D",
                "marker": {"symbol": "circle", "fillColor": "#DDDF0D"},
                "dashStyle": "Solid",
                "stacking": self.stacking,
                ...
                "yAxis": "0",
                "data": [9646062.0, 10428632.0, 12255311.0, 13286254.0, 12694243.0, 13237598.0],
                "color": "#55BF3B",
    ...
    def test_uni_dim_with_ref_line_chart(self):
        ...
        self.assertEqual({
            ...
            "series": [{
                ...
                "name": "Votes (Texas)",
                "yAxis": "0",
                "data": [6233385.0, 7359621.0, 8007961.0, 7877967.0, 5072915.0],
                "color": "#DDDF0D",
                "marker": {"symbol": "circle", "fillColor": "#DDDF0D"},
                "dashStyle": "Solid",
                "stacking": self.stacking,
                ...
                "yAxis": "0",
                "data": [5574387.0, 6233385.0, 7359621.0, 8007961.0, 7877967.0],
                "color": "#DDDF0D",
                "marker": {"symbol": "circle", "fillColor": "#DDDF0D"},
                "dashStyle": "ShortDash",
                "stacking": self.stacking,
                ...
                "name": "Votes (California)",
                "yAxis": "0",
                "data": [10428632.0, 12255311.0, 13286254.0, 12694243.0, 13237598.0],
                "color": "#55BF3B",
                "marker": {"symbol": "square", "fillColor": "#55BF3B"},
                "dashStyle": "Solid",
                "stacking": self.stacking,
                ...
                "yAxis": "0",
                "data": [9646062.0, 10428632.0, 12255311.0, 13286254.0, 12694243.0],
                "color": "#55BF3B",
                "marker": {"symbol": "square", "fillColor": "#55BF3B"},
                "dashStyle": "ShortDash",
                "stacking": self.stacking,
    ...
    def test_uni_dim_with_ref_delta_line_chart(self):
        ...
        self.assertEqual({
            ...
            "series": [{
                ...
                "yAxis": "0_eoe_delta",
                "data": [-658998.0, -1126236.0, -648340.0, 129994.0, 2805052.0],
                "color": "#DDDF0D",
                "marker": {"symbol": "circle", "fillColor": "#DDDF0D"},
                "dashStyle": "ShortDash",
                "stacking": self.stacking,
                ...
                "yAxis": "0_eoe_delta",
                "data": [-782570.0, -1826679.0, -1030943.0, 592011.0, -543355.0],
                "color": "#55BF3B",
                "marker": {"symbol": "square", "fillColor": "#55BF3B"},
                "dashStyle": "ShortDash",
                "stacking": self.stacking,
