...
class FilterDateFieldTests(TestCase):
    ...
    def test_eq_expr_datetime(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "date"=\'2019-03-06T09:36:11\'', str(queries[0]))
    ...
    def test_eq_expr_datetime_timezone(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "date"=\'2019-03-06T09:36:11+00:00\'', str(queries[0]))
    ...
    def test_in_expr(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "date" IN (\'2019-03-06\',\'2019-03-07\')', str(queries[0]))
    ...
    def test_notin_expr(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "date" NOT IN (\'2019-03-06\',\'2019-03-07\')', str(queries[0]))
    ...
    def test_between_expr(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "date" BETWEEN \'2019-03-06\' AND \'2019-03-07\'', str(queries[0]))
...
class FilterNumberFieldTests(TestCase):
    ...
    def test_eq_expr_float(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "number"=1.0', str(queries[0]))
    ...
    def test_in_expr(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "number" IN (5,7)', str(queries[0]))
    ...
    def test_notin_expr(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "number" NOT IN (5,7)', str(queries[0]))
    ...
    def test_between_expr(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "number" BETWEEN 5 AND 7', str(queries[0]))
...
class FilterTextFieldTests(TestCase):
    ...
    def test_in_expr_date(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "text" IN (\'abc\',\'def\')', str(queries[0]))
    ...
    def test_notin_expr_date(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "text" NOT IN (\'abc\',\'def\')', str(queries[0]))
    ...
    def test_like_expr_str(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE LOWER("text") LIKE LOWER(\'abc%\')', str(queries[0]))
    ...
    def test_not_like_expr_str(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE NOT LOWER("text") LIKE LOWER(\'abc%\')', str(queries[0]))
...
class FilterBooleanFieldTests(TestCase):
    ...
    def test_eq_expr_bool_true(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "boolean"=true', str(queries[0]))
    ...
    def test_eq_expr_bool_false(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE "boolean"=false', str(queries[0]))
    ...
    def test_is_false(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'WHERE NOT "boolean"', str(queries[0]))
...
class FilterAggregateNumberFieldTests(TestCase):
    def test_eq_expr_int(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'HAVING SUM("number")=1', str(queries[0]))
    ...
    def test_eq_expr_float(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'HAVING SUM("number")=1.0', str(queries[0]))
    ...
    def test_ne_expr(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'HAVING SUM("number")<>5', str(queries[0]))
    ...
    def test_in_expr(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'HAVING SUM("number") IN (5,7)', str(queries[0]))
    ...
    def test_notin_expr(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'HAVING SUM("number") NOT IN (5,7)', str(queries[0]))
    ...
    def test_between_expr(self):
        ...
        self.assertEqual('SELECT '
                         'SUM("number") "$aggr_number" '
                         'FROM "test" '
                         'HAVING SUM("number") BETWEEN 5 AND 7', str(queries[0]))
